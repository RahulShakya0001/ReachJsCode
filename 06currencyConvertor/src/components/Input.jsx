...
function InputBox({
  ...
  return (
    <div
      className={`bg-white/30 overflow-hidden p-3 rounded-lg text-sm flex ${className}`}
    >
      <div className="w-1/2">
        <label
      ...
      <div className="w-1/2 flex flex-wrap justify-end text-right">
        ...
        <select
          className="rounded-lg px-1 py-1 bg-white/50 cursor-pointer outline-none text-black"
